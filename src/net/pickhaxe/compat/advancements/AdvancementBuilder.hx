...
{
  var _inner:AdvancementBuilder_Minecraft = new AdvancementBuilder_Minecraft();
  ...
  function buildDisplayInfo() {
    ...
    _inner.display(currentDisplayInfo);
